...
from mi.dataset.parser.dosta_ln_wfp_sio_mule import DostaLnWfpSioMuleParser, StateKey
...
@attr('UNIT', group='mi')
class DostaLnWfpSioMuleParserUnitTestCase(ParserUnitTestCase):
    """
    dosta_ln_wfp_sio_mule Parser unit test suite
    """
